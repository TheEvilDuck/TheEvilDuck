...
local animNames = { 
	idle = 	{	
		{ id = "http://www.roblox.com/asset/?id=6710411605", weight = 10 }
			},
	walk = 	{ 	
		{ id = "http://www.roblox.com/asset/?id=6712856607", weight = 10 } 
			}, 
	run = 	{
		{ id = "http://www.roblox.com/asset/?id=6712856607", weight = 10 } 
			}, 
	...
	jump = 	{
		{ id = "http://www.roblox.com/asset/?id=6991538135", weight = 10 } 
			}, 
	fall = 	{
		{ id = "http://www.roblox.com/asset/?id=6991538135", weight = 10 } 
			}, 
